import { Nav, Navbar, Card, Row, Col } from 'react-bootstrap';
...
export default function ShefProducts() {
    return (
        <>
            <div >
                <Navbar bg="dark" variant="dark">
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Navbar.Brand>OnAution</Navbar.Brand>
                        <Nav className="me-auto">
                            <Link to="/user/favorite" style={styles.linkNav}> SP ưa thích</Link>
                            <div style={{ width: 10 }}/>
                            <Link  to="#" style={styles.linkNav}> SP đấu giá</Link>
                            <div style={{ width: 10 }}/>
                            <Link to="/user/shef"style={styles.linkNavActive}> SP lên kệ</Link>
                        </Nav>
                    </Navbar.Collapse>
                    <Link to="/user/profile" className='m-3' ><CgProfile size={24} style={{ color: 'grey' }} /></Link>
                </Navbar>
                <h5 className="d-flex justify-content-center mt-4">Sản phẩm đang đấu giá của bạn!</h5>
            </div>
                                ...
                                <Col>
                                    <Card style={styles.card} >
                                        ...
                                        <Card.Body style={styles.cardBody}>
                                            <Card.Title style={styles.cardTitle}> Bạch Cẩu &nbsp;&nbsp;<AiOutlineHeart /></Card.Title>
