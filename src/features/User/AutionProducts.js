    ...
    return (
        <>
            <div >
                <Navbar bg="dark" variant="dark">
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="me-auto">
                            ...
                            <div style={{ width: 10 }} />
                            <Link to="#" style={styles.linkNavActive}> SP đấu giá</Link>
                            <div style={{ width: 10 }} />
                ...
                <h5 className="d-flex justify-content-center mt-4">Sản phẩm bạn đã đấu giá!</h5>
            </div>
                                    ...
                                    <Card style={styles.card} >
                                        ...
                                        <Card.Body style={styles.cardBody}>
                                            ...
                                            <Card.Text style={styles.cardText} >
                                                ...
                                                Lượt đấu giá: 2
                                                <br />
                                                <Link href="/product/detail" style={{ fontSize: '0.6rem' }}>Xem chi tiết</Link>
                                            </Card.Text>
                                        </Card.Body>
                                    </Card>
                                </Col>
