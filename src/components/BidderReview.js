...
export default function BidderReview() {
    ...
    return (
        <>
            <h5 className="d-flex justify-content-center mt-4">Các đánh giá của người mua!</h5>
                    ...
                    <Row style={styles.text}>
                        ...
                        <Col className="col-md-3 m-2">
                            ...
                            <p className="card-text">
                                Giá đấu giá: 1000₫ <br />
                                Giá bán: 10 000₫ <br />
                                Người mua: Lê Văn A &nbsp;&nbsp;&nbsp;&nbsp;  Đánh giá:&nbsp; <FaThumbsUp className='mb-1' style={{ color: 'blue' }} />
                                <br />
                                Đăng: 20:30:00 Ngày 10/10/2021
                                <br />
                                Kết thúc: 20:30:00 Ngày 11/10/2021<br />
                                <b >Điểm hiện tại của bạn: 10 điểm</b>
                            </p>
