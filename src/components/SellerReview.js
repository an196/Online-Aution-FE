...
export default function SellerReivew() {
    ...
    return (
        <>
            <h5 className="d-flex justify-content-center mt-4">Các đánh giá của người bán!</h5>
                    ...
                    <Row style={styles.text}>
                        ...
                        <Col className="col-md-3 m-2">
                            ...
                            <p className="card-text">
                                Giá đấu giá: 1000₫ <br />
                                Giá bán: 10 000₫ <br />
                                Người bán: Lê Văn A &nbsp;&nbsp;&nbsp;&nbsp;  Đánh giá:&nbsp; <FaThumbsUp className='mb-1' style={{ color: 'blue' }} />
                                <br />
